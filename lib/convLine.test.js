...
test('checks AFS ok ', () => {
  let {l, cs} = cl.convLine('SECTION: AFS SECTION IBM HEADING', 'normal')
  expect(l).toBe('## AFS Section IBM Heading')
})
...
test('checks figure end', () => {
  ...
  expect(l).toBe(`<img src="newfigs/scanFig1-1.jpg" alt="Figure 1-1: The AFS Architecture" height="300" width="400"/> <p>Figure 1-1: The AFS Architecture</p>`)
})
